...
class FindProcessTextActivity : BaseSelectionProcessTextActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val text = selectedText()
        val result = Intent(ACTION_OPTIREADER_FIND_SELECTION).putExtra(EXTRA_FIND_QUERY, text)
...
const val ACTION_OPTIREADER_FIND_SELECTION = "com.example.optireader.ACTION_FIND_SELECTION"
